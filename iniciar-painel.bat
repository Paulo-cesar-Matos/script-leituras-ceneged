...
start "Leitura Repe" /MIN cmd /k "timeout /t 900 /nobreak > nul && cd C:\Users\paulomatos\Documents\GitHub\extrair-para-acomp-diario && C:\Python314\python.exe extracao_leitura_repe.py"
